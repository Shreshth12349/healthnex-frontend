...
const appointments: Appointment[] = [
    {
        ...
        patientImage: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80',
    ...
    },
    {
        ...
        patientImage: 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=256&h=256&q=80',
    ...
    },
    {
        ...
        patientImage: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=256&h=256&q=80',
    ...
    },
    {
        ...
        patientImage: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=256&h=256&q=80',
    ...
    },
    {
        ...
        patientImage: 'https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=256&h=256&q=80',
    ...
    },
    {
        ...
        patientImage: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=256&h=256&q=80',
        location: 'Clinic Room 3',
    ...
    },
    {
        ...
        patientImage: 'https://images.unsplash.com/photo-1499996860823-5214fcc65f8f?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=256&h=256&q=80',
        location: 'Clinic Room 2',
                    ...
                    {filteredAppointments.length > 0 ? filteredAppointments.map((appointment) => (
                        <li key={appointment.id} className="relative flex space-x-6 py-6 xl:static">
                            ...
                            <div className="flex-auto">
                                <h3 className="pr-10 font-semibold text-gray-900 xl:pr-0">{appointment.patientName}</h3>
                            ...
                            <Menu as="div"
                                ...
                                <MenuItems
                                    ...
                                    <div className="py-1">
                                        <MenuItem>
                                            <a href="#"
                                               className="block mx-2 my-1 p-2 text-sm text-gray-700 rounded-md hover:bg-gray-300">View
                                                Details</a>
                                        </MenuItem>
                                        <MenuItem>
                                            <a href="#"
                                               className="block mx-2 my-1 p-2 text-sm text-gray-700 rounded-md hover:bg-gray-300">Reschedule</a>
                                        </MenuItem>
                                        <MenuItem>
                                            <a href="#"
                                               className="block mx-2 my-1 p-2 text-sm text-gray-700 rounded-md hover:bg-gray-300">Cancel
                                                Appointment</a>
                                        </MenuItem>
                                    </div>
                                </MenuItems>
