...
const artifacts: any[] = [
    {
        ...
        category: "Medicine",
        detail: "A common over-the-counter pain reliever and fever reducer. Contains paracetamol as the active ingredient. Safe for most adults and children, but consult a doctor for children under 2 years old.",
        trust_score: 89,
        ...
        instructions: "Take with food as advised by your doctor. Do not chew or crush the tablet.",
        warnings: {
            "alcohol": "Unsafe",
    ...
    },
    {
        ...
        category: "Medicine",
        detail: "popular pain reliever and anti-inflammatory drug. Can be used for headaches, muscle aches, and fever. However, it can cause stomach upset, so take it with food or milk.",
        trust_score: 67,
        marketer: "Cipla Ltd",
        composition: {
        ...
        instructions: "Take with food or milk to avoid stomach upset. Do not exceed the recommended dose.",
        warnings: {
            "alcohol": "Unsafe",
            "pregnancy": "Consult your doctor",
    ...
    },
    {
        ...
        detail: "A scholarly journal that focuses on the scientific study of pain. It covers topics such as pain pathways, neuroinflammation, chronic pain, and neuropathic pain. This journal is highly respected in the field of neuroscience.",
        trust_score: 85,
        publisher: "Elsevier",
    ...
    },
    {
        ...
        category: "Book",
        detail: "A classic textbook on neuroscience that provides a comprehensive overview of the nervous system. It covers topics such as neuroanatomy, synaptic transmission, sensory systems, and motor systems. This book is widely used in university courses.",
        trust_score: 54,
    ...
    },
    {
        ...
        detail: "A scientific study that investigates the role of dopamine in the brain's reward system. Dopamine is a neurotransmitter involved in pleasure and motivation. This research has implications for understanding addiction and mental health disorders.",
        trust_score: 81,
        author: "Dr. Emma Thompson",
        publication: "Journal of Neuroscience Research",
        doi: "10.1002/jnr.24539",
        year_published: 2020,
        abstract: "This paper explores the role of dopamine in regulating reward circuits, focusing on its implications in addiction and mental health disorders.",
        keywords: [
            "Dopamine",
            "Reward pathways",
            "Addiction",
    ...
    },
    {
        ...
        detail: "A large-scale research initiative that aims to map the human brain's connections. It involves collecting MRI scans, behavioral data, and genetic data from thousands of participants. This dataset is a valuable resource for neuroscientists studying brain structure and function.",
        trust_score: 70,
