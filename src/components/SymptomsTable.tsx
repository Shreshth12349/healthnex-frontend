...
export default function SymptomsTable() {
  ...
  const [newSymptom, setNewSymptom] = useState({ symptom: "", duration: "", severity: "" });
    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-base font-semibold leading-6 text-gray-900">Symptoms</h1>
          <p className="mt-2 text-sm text-gray-700">
            A list of all the symptoms. Extracted from WhatsApp conversation (from text and reports uploaded)
          </p>
        </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white rounded-lg p-6 shadow-lg">
            <h2 className="text-lg font-medium text-gray-900">Add New Symptom</h2>
            <div className="mt-4">
              <input
                type="text"
                placeholder="Symptom"
