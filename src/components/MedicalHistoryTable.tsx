        ...
        <div className="px-4 sm:px-6 lg:px-8">
            <div className="sm:flex sm:items-center">
                <div className="sm:flex-auto">
                    <h1 className="text-base font-semibold leading-6 text-gray-900">Medical Records</h1>
                    <p className="mt-2 text-sm text-gray-700">
                        A list of all the medical records including the date, condition, diagnosis, doctor/physician, status, and notes/details.
                    </p>
                </div>
                            ...
                            <table className="min-w-full divide-y divide-gray-300">
                                ...
                                {medicalHistory.map((record) => (
                                    <tr key={record.date}>
                                        ...
                                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{record.condition}</td>
                                        ...
                                        <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                            <a href="#" className="text-indigo-600 hover:text-indigo-900">
                                                Edit<span className="sr-only">, {record.condition}</span>
                                            </a>
                                        </td>
                                    </tr>
                                ))}
