...
export default function ArtifactSideDrawer({isDrawerOpen, setIsDrawerOpen, selectedArtifact}: ArtifactSideDrawerProps) {
    return (
        <Dialog open={isDrawerOpen} onClose={setIsDrawerOpen} className="relative z-100">
                                    ...
                                    <div className="px-4 py-5 sm:px-0 sm:py-0">
                                        <dl className="space-y-8 sm:space-y-0 sm:divide-y sm:divide-gray-200">
                                            <div className="sm:flex sm:px-6 sm:py-5">
                                                <dt className="text-sm font-medium text-gray-500 sm:w-40 sm:flex-shrink-0 lg:w-48">Category</dt>
                                                <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:ml-6 sm:mt-0">{selectedArtifact.category}</dd>
                                            </div>
                                            <div className="sm:flex sm:px-6 sm:py-5">
                                            ...
                                            {selectedArtifact.category === "Medicine" && (
                                                <>
                                                    ...
                                                    <div className="sm:flex sm:px-6 sm:py-5">
                                                        ...
                                                        <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:ml-6 sm:mt-0">
                                                            <ul>
                                                                {Object.entries(selectedArtifact.warnings).map(([key, value]) => (
                                                    ...
                                                    <div className="sm:flex sm:px-6 sm:py-5">
                                                        ...
                                                        <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:ml-6 sm:mt-0">
                                                            <ul>
                                                                {selectedArtifact.substitutes.map(substitute => (
                                            ...
                                            {selectedArtifact.category === "Research Paper" && (
                                                <>
                                                    <div className="sm:flex sm:px-6 sm:py-5">
                                                        <dt className="text-sm font-medium text-gray-500 sm:w-40 sm:flex-shrink-0 lg:w-48">Author</dt>
                                                        <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:ml-6 sm:mt-0">
